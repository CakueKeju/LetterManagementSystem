...
// Initialize with existing selected users if any
@if(old('selected_users', $formData['selected_users'] ?? []))
    @foreach(old('selected_users', $formData['selected_users'] ?? []) as $userId)
