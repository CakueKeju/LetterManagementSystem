    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="alert alert-info">
                ...
                <p class="mb-0">Isi form untuk melihat nomor surat yang tersedia, lalu upload file yang sudah berisi nomor tersebut.</p>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-update nomor surat when form changes
    function updateNomorSurat() {
        ...
        if (!jenisSuratId || !tanggalSurat || !perihal) {
            nomorSuratDisplay.innerHTML = '<span class="text-muted">Lengkapi form untuk melihat nomor surat</span>';
        ...
        .then(data => {
            if (data.next_nomor_urut) {
                ...
                // Lock this nomor surat
                lockNomorSurat(jenisSuratId, nomorUrut);
                
                trackActivity(); // Reset activity timer
            } else {
                nomorSuratDisplay.innerHTML = '<span class="text-danger">Error: Tidak dapat generate nomor surat</span>';
                copySection.style.display = 'none';
                uploadSection.style.display = 'none';
            }
        })
        .catch(error => {
            ...
            nomorSuratDisplay.innerHTML = '<span class="text-danger">Error saat mengambil nomor surat</span>';
            copySection.style.display = 'none';
            uploadSection.style.display = 'none';
        });
    }
    ...
    function resetInactivityTimer() {
        ...
        inactivityTimeout = setTimeout(function() {
            if (confirm('Anda sudah tidak aktif selama 8 menit. Apakah Anda masih di sini?')) {
                extendLock();
                resetInactivityTimer();
            } else {
    ...
    jenisSuratSelect.addEventListener('change', function() {
        ...
        updateNomorSurat(); // Instant update for dropdown changes
    });
    tanggalSuratInput.addEventListener('change', function() {
        console.log('Tanggal surat changed to:', this.value);
        updateNomorSurat(); // Instant update for date changes
    });
