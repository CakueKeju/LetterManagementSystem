...
<div class="container">
    ...
    <div class="d-flex justify-content-between">
        ...
        <div>
            <a href="{{ route('surat.confirm') }}" class="btn btn-warning" onclick="return confirm('Yakin ingin kembali ke halaman edit? Data yang sudah diisi akan hilang.')">
                <i class="fas fa-edit"></i> Edit Data
            </a>
            <form action="{{ route('surat.final-store') }}" method="POST" style="display: inline;" id="finalStoreForm">
                @csrf
